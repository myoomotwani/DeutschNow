      ...
      <div className="w-full flex flex-col space-y-1 lg:space-y-2 xl:space-y-3 items-center justify-center">
        ...
        <div className='flex flex-col sm:pt-4 space-y-5 items-center justify-center w-full'>
          <span className='text-center pb-3 border-b border-b-cyan-500'>
            ...
            <span className='text-sm sm:text-base'>Practice speaking German with real life scenarios. Speak your lines to keep the conversation going.</span>
          </span>
          <Link href={"/practice/scenario1"}>
            <div className='bg-gradient-to-r p-2 rounded-3xl bg-clip-border border-2 from-green-400 to-cyan-400'>
              <span className='w-full rounded-xl p-1 px-2 bg-white hover:bg-gradient-to-r from-green-400 to-cyan-400 text-[11px] text-center sm:text-base hover:text-white'>Scenario 1: Buying a Train Ticket</span>
            </div>
          </Link>
          <Link href={"/practice/scenario2"}>
            <div className='bg-gradient-to-r p-2 rounded-3xl bg-clip-border border-2 from-cyan-400 to-green-400'>
              <span className='w-full rounded-xl p-1 px-2 bg-white hover:bg-gradient-to-r text-[11px] sm:text-base text-center from-cyan-400 to-green-400 hover:text-white'>Scenario 2: Going Through Immigration</span>
            </div>
          </Link>
          <Link href={"/practice/scenario3"}>
            <div className='bg-gradient-to-r p-2 rounded-3xl bg-clip-border border-2 from-green-400 to-cyan-400'>
              <span className='w-full rounded-xl p-1 px-2 bg-white hover:bg-gradient-to-r text-[11px] sm:text-base text-center from-green-400 to-cyan-400 hover:text-white'>Scenario 3: Handling Lost Luggage at the Airport</span>
            </div>
          </Link>
        </div>
      </div>
