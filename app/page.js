  ...
  return (
    <main className="bg-white py-1 xl:py-3 h-screen text-black overflow-x-hidden">
      ...
      <div className="w-full flex flex-col space-y-1 lg:space-y-2 xl:space-y-3 items-center justify-center">
        ...
        <select onChange={handleScenarioChange} className="p-2 border border-blue-700 rounded-xl outline-0 ring-0">
          <option value="1">Scenario 1: Buying a Ticket</option>
          <option value="2">Scenario 2: Asking for Directions</option>
          <option value="3">Scenario 3: Finding a Restaurant</option>
        </select>
        <div className="w-[90%] !mt-2 sm:w-[80%] md:w-[70%] flex flex-col items-center justify-center shadow-[#00000017] shadow-lg drop-shadow-lg rounded-lg">
          ...
          <div className="overflow-y-scroll w-full space-y-3 rounded-2xl p-3 h-60 sm:h-52 md:h-48 xl:h-60" ref={scrollableSectionRef}>
            ...
            {currentDialogueIndex > dialogues.length - 1 && isCorrect && <span className="px-3 py-1 sm:py-2 text-green-500 text-center text-[10px] sm:text-xs md:text-sm border-t border-green-500">Success!!!<br/>You&apos;ve practiced your speaking skills at a bus stand. You&apos;re now better equipped to handle the ticket booking process in Hindi.</span>}
